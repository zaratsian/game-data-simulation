...
if __name__ == "__main__":
    ...
    if args.dataLocation == 'pubsub':
        ...
        if args.dataLocation == 'cloudstorage':
            ...
            '''
            # Create Table
            gcpHelpers.createBQTable(gcpProjectID=args.gcpProjectId, bqDataset=args.bigquery_dataset, bqTable=args.bigquery_tablename, schema=simConfig.bqSchemaDaily)
